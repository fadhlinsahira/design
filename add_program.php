...
<center>
    ...
    <form action="add_program2.php" method="POST">
    <table   border="1" width="80%" height="150px">
	 
	<div class="main">
	   <tr>
	   <th colspan="7" id="tajuk">TAMBAH PROGRAM</th> 
	   </tr>
	   
			<tr>
			     <td>NAMA PROGRAM</td>
				 <td><input type="text" name="namaprogram" placeholder=""></td>
			</tr>
			...
			<tr>
			     <td>TEMPAT</td>
				<td><input type="text" name="tempat" placeholder=""></td>
			</tr>
